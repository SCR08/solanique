...
function sg_get_professional_credentials( bool $authorized_only = true ): array {
	$credentials = array(
		array(
			...
			'logo_width'      => 275,
			'logo_height'     => 103,
			'visible_title'   => 'SANDRA LORENA MEDINA SOLANO',
			'secondary_title' => 'MORTGAGE AGENT-LEVEL 1',
			'credential_lines' => array(
			...
			'authorized'      => true,
			'display_order'   => 10,
			'notes'           => 'Client-provided CSI Mortgages logo, website, and approved visible professional credential wording.',
		),
		array(
			...
			'authorized'      => true,
			'display_order'   => 20,
			'notes'           => 'Client-provided Century 21 / C21HG logo and approved visible professional credential wording.',
		),
	);
